<form action="/perguliran_i/{{ $perguliran_i->id }}" method="post" id="FormInputV">
    ...
    <div class="card mb-3">
        ...
        <div class="card-body p-3">
            ...
            <input type="hidden" name="status" id="status" value="V4">

            <div class="row">
                <div class="col-md-3">
                    <div class="form-group mb-3">
                        <label for="tgl_verifikasi" class="form-label">Tgl  {{$v4}}</label>
                ...
                <div class="col-md-3">
                    <div class="form-group mb-3">
                        <label for="verifikasi" class="form-label"> {{$v4}} Rp.</label>
            ...
            <div class="form-group mb-3">
                <label for="catatan_verifikasi" class="form-label">Catatan  {{$v4}}</label>
