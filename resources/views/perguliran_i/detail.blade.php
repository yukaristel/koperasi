    ...
    @if ($perguliran_i->status == 'P')
        <div class="card mb-3">
            <div class="card-body p-2 pb-0">
                <button type="button" class="btn btn-info btn-sm mb-2" id="BtnEditProposal">Edit Proposal</button>
                        ...
                        <div class="row">
                            @foreach ($dokumen_proposal as $doc => $val)
                                <div class="col-md-3 d-grid">
                                    @if ($val['withExcel'])
                                        <div class="btn-group">
                                            <button class="btn btn-success btn-sm text-start" type="submit" name="report"
                                                value="{{ $val['file'] }}#pdf">
...
@section('script')
    ...
    $(document).on('click', '#simpan_waiting', function (e) {
        e.preventDefault();
        $('small.text-danger').text('');
