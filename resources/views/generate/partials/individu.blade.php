@php
    ...
    $continue = [
        'jenis_pinjaman', 'id_pinkel', 'pendapatan', 'biaya',
        'aktiva', 'pasiva', 'jaminan',
...
<form class="form-generate">
    ...
    <div style="margin-bottom:16px;font-size:13px;color:#94a3b8;">
        ...
        <b style="color:#e2e8f0;">GENERATE INDIVIDU</b>
        &mdash; {{ $kec->nama_kec }} [{{ $kec->id }}], {{ $kec->kabupaten->nama_kab }}
        <br>
        <small style="color:#475569;margin-top:4px;display:block;">
            Biarkan semua value kosong untuk generate seluruh pinjaman individu.
        </small>
    </div>
    ...
    <div style="display:flex;justify-content:flex-end;margin-top:20px;">
        <button type="submit" class="btn-generate">
            <i class="fas fa-play"></i> Generate Individu
        </button>
    </div>
</form>
